...
FRAMES = [
    # state, screen text, screen colour, arm pose, extras
    ("dormant",  ".",     "s", "down",   {}),
    ("watching", "-",     "G", "down",   {}),
    ("watching", "- -",   "G", "down",   {"scan": True}),
    ("reading",  "19",    "A", "mid",    {}),
    ("reading",  "19",    "A", "mid",    {"scan": True}),
    ("halt",     "No 14", "R", "up",     {"stamp": True}),
    ("halt",     "No 14", "R", "mid",    {"stamp": True}),
    ("halt",     "No 14", "R", "strike", {"stamp": True, "impact": True}),
    ("halt",     "No 14", "R", "strike", {"stamp": True}),
    ("cleared",  "OK",    "G", "down",   {}),
    ("cleared",  "OK",    "G", "down",   {"scan": True}),
]
...
def sheet() -> tuple[Image.Image, dict]:
    ...
    meta = {
        ...
        "timing": {"dormant": 0, "watching": 900, "reading": 320,
                   "halt": 110, "cleared": 700},
        "loop": {"dormant": False, "watching": True, "reading": True,
                 "halt": False, "cleared": True},
    }
    return im, meta
